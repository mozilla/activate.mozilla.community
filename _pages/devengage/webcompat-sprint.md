...
Web Compatibility, the ability for all Web content to run in all browsers, is important. There are multiple web content engines running on multiple devices, and sometimes with a little testing and some small tweaks to their site, developers can ensure that more users can have the full experience that is desired. For more background and data on Web Compatibility, read the recent blog post on Mozilla Hacks <https://hacks.mozilla.org/2016/07/make-the-web-work-for-everyone/>.
...
* [Install the Webcompat.com Reporter add-on](https://addons.mozilla.org/firefox/addon/webcompatcom-reporter/)
    * We have a mobile add-on people can install for Fennec Beta and in 50 there will be a default "Report Site Issue" menu item in Fennec Aurora and Nightly.
...
1. Bug diagnosis (deep technical dives)
2. Site outreach (contacting sites)
