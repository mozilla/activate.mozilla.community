...
commonvoice-activity-general = A useable dataset needs at least 2000 hours of validated voice clips from at least 1000 different voices. For high production quality we estimate 10000 hours. Beyond a large number of speakers, a quality dataset benefits from a diversity of voices and recording qualities that account for gender, age, accents, and even background noise. We rely on our global communities to represent this type of diversity and have set a goal of 200 hours of validated voice clips in some locales by the end of June.
commonvoice-activity-general-2 = Your community can make a difference by sharing your voices, reviewing voice clips, and unleashing a viral effect to get more people involved and promoting the Common Voice project.
...
commonvoice-activity-solo-description = Try a marathon session or create a routine that makes it easy to  fit contributions into your daily schedule. For example, you can use routine downtime — like the commercials of your favourite TV show, or every day while you’re waiting for the bus — towards contributing. If you associate contributing with a regular task it will be easy to remember and you’ll get to make a meaningful difference every day!
commonvoice-activity-solo-description-2 = Remember, because we need a diversity of voices, donating just 15 minutes of your voice — around 225 clips — is plenty. If everyone reviews 450 clips, we’ll meet our voice goals in time, but there’s no limit to how many clips you can review!
commonvoice-activity-solo-record = To donate your voice
commonvoice-activity-solo-record-2 = Visit https://voice.mozilla.org and create an account. (Subscribe to the newsletter to stay up to date with the Common Voice project!)
...
commonvoice-activity-solo-record-6 = Keep recording until you’ve reached at least five sentences and then click submit.
commonvoice-activity-solo-record-7 = Repeat until you hit 225!
commonvoice-activity-solo-review = To review clips
commonvoice-activity-solo-review-2 = Once you’ve reached 15 minutes of voice contributions, the dataset will benefit more if you go to the Listen portal and review other people’s clips.
commonvoice-activity-solo-review-3 = From the homepage, click on “Listen.”
commonvoice-activity-solo-review-4 = Listen to the voice (try not to read the screen).
commonvoice-activity-solo-review-5 = Now read the sentence  and compare it with what you heard.
commonvoice-activity-solo-review-6 = If the voice clip matches the sentence, click “yes.” If the voice clip doesn’t match the sentence, click “no.” (Note: different accents are fine, and encouraged!)
commonvoice-activity-solo-review-7 = Repeat
commonvoice-activity-solo-end = Once you have recorded 225 clips and reviewed at least 450, it’s probably time for the next challenge. Check the “Fun with friends” activity.
commonvoice-activity-friends = 👨‍👩‍👧‍👦 Fun with friends
commonvoice-activity-friends-description-gather = Gather up to 10 friends or family members and set a goal for the number of voice clips you want to review and contribute during your time together. Want to make a game of it? Offer a price for whoever reaches your goal first, or for whoever can get to the highest number of reviews during the event! Prizes can be something like stickers or even as simple as a shout-out at the event. Just make sure your goals can be accomplished in the time you have allotted.
commonvoice-activity-friends-description-track = Track your progress on the website.
commonvoice-activity-friends-description-3 = Introduce participants to the Common Voice project by visiting the website <voiceLink>voice.mozilla.org</voiceLink> together. Talk about why it’s important and show them how easy contributing is with just a smartphone. Here are some <slidesLink>SLIDES</slidesLink> that might be helpful.
commonvoice-activity-friends-description-4 = Have all your participants create an account on their device.
commonvoice-activity-friends-description-5 = Spend 15 minutes recording voice clips. (Note: you may need to spread out a bit if you’re in a noisy space.) To start, click on:
commonvoice-activity-friends-description-6 = Spend the rest of the time reviewing other people’s voices using the “Listen” portal on the Common Voice homepage.
commonvoice-activity-friends-description-7 = Make sure your participants have an account set up so everyone can keep track of their contributions using the counter at the top of the website:
...
commonvoice-activity-friends-description-9 = Once someone hits their goal, check their contributions and start handing out prizes!
commonvoice-activity-friends-end = Invite your participants to share their progress on social media using #CommonVoice and encourage them to run this same activity with a group of friends.
commonvoice-activity-time = 🤹‍♀️ Show time
commonvoice-activity-time-description = Make it a big event! Gather your colleagues, classmates, or friends together for a giant Common Voice contribute-a-thon. Here is a <posterLink>POSTER</posterLink> you can use at your event.
commonvoice-activity-time-description-2 = For big events we recommend spending some time introducing participants to the project before announcing your group goals. Consider offering up prizes for participants who complete the largest number of recordings.
commonvoice-activity-time-description-3 = Don’t forget to remind your participants that Common Voice needs a diversity of voices and recordings, so donating just 15 minutes of their time is plenty (that’s about 225 clips).
commonvoice-activity-time-description-4 = Intro to the project (10 minutes)
commonvoice-activity-time-description-5 = The activity owner should deliver a 10-minute presentation introducing the Common Voice project. Here are some <slidesLink>SLIDES</slidesLink> that you can use. Some key questions the presentation should cover include:
...
commonvoice-activity-time-description-11 = Individuals will sign in to the Common Voice site and donate their voices for approximately 15 minutes. If the space is small or loud you may want to split the group in two, with one half donating voice clips and the other half reviewing clips, switching after 15 minutes.
commonvoice-activity-time-description-12 = Review time! (30 minutes)
commonvoice-activity-time-description-13 = Once everyone is done sharing their voice, have the group split up into pairs. One person will play the recording on their device and the other person will listen (without reading the screen). The listener will repeat what they heard to confirm if the voice clip is accurate.
commonvoice-activity-time-description-14 = After 15 minutes, ask the pairs to switch roles.
commonvoice-activity-time-description-15 = Wrap-up and sharing (5 minutes)
commonvoice-activity-time-description-16 = The activity owner will ask participants to share their progress and broadcast the event using #CommonVoice on social media.
commonvoice-activity-crowd = 🤩 Reach the Crowd
commonvoice-activity-crowd-description = The next time you’re at a conference or have access to a large public space where you can set up a booth, try collecting as many voices as possible for the Common Voice project.
commonvoice-activity-crowd-description-2 = We recommend setting up at least one or two devices using Firefox in full-screen mode with the Common Voice website pre-loaded. You can use this Common Voice <posterLink>POSTER</posterLink> and Instructions <signageLink>DOCUMENT</signageLink> to help teach participants how to contribute.
commonvoice-activity-crowd-description-5 = Use your contribution booth to explain to participants how their voices can help create a public dataset that benefits everyone.
commonvoice-activity-crowd-description-6 = Examples:
commonvoice-activity-crowd-description-7 = Hello! How are you doing? Did you know you can help make voice recognition technologies work better for everyone by donating your voice?
commonvoice-activity-crowd-description-8 = Hi! Do you have a minute to talk about data privacy and voice technology? The Common Voice project is Mozilla’s initiative to help machines understand how real people talk.
commonvoice-activity-crowd-description-9 = Hello there! Do you have a minute to help our open-source voice technology initiative?
commonvoice-activity-crowd-description-10 = After this initial approach, quickly introduce people to the Common Voice project and invite them to donate a few minutes of their time to contribute.
