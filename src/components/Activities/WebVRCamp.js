        ...
        <Col lg={9} md={9} sm={9} xs={12}>
          ...
          <ul>
            <Localized id="vr-activity-flow-3"
              ...
              <li>Introduction of speakers and attendees with an ice breaker session (e.g., <a href="https://businessmajors.about.com/od/icebreakers/a/Icebreaker8.htm">catch the ball</a>)</li>
            </Localized>
          ...
          <ul>
            ...
            <Localized id="vr-activity-flow-13"
              ...
              <li>Can get started with <a href="https://codepen.io/mozvr/pen/BjygdO">Codepen</a> or the <a href="https://github.com/aframevr/aframe-boilerplate">Boilerplate</a></li>
            </Localized>
            <ul>
