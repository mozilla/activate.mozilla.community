    ...
    return (
      <ActivityDetail
        ...
        <Col lg={9} md={9} sm={9} xs={12}>
          ...
          <Localized id="webext-activity-planning">
          ...
          <Localized id="webext-activity-flow">
            <h2 id="flow-of-workshops">Flow of Workshops</h2>
          </Localized>

          <Localized id="webext-activity-flow-1">
          ...
          <Localized id="webext-activity-first">
          ...
          <Localized id="webext-activity-second">
          ...
          <Localized id="webext-activity-third">
          ...
          <Localized id="webext-activity-resources">
        ...
        <Col lg={3} md={3} sm={3} className="sidebar hidden-xs">
          <Localized id="webext-activity-impact">
            <h2 id="impact-and-metrics">Impact and Metrics</h2>
          </Localized>

          <Localized id="webext-activity-impact-1">
          ...
          <Localized id="webext-activity-goals">
            <h3 id="campaign-goals">Campaign Goals</h3>
          </Localized>

          <Localized id="webext-activity-impact-2">
          ...
          <Localized id="webext-activity-impact-5">
          ...
          <Localized id="webext-activity-goals-workshop">
          ...
          <Localized id="webext-activity-participants">
